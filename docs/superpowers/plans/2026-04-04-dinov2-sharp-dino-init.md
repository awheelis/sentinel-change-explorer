...
2. Run: `uv run python -m src.experimental.build_dataset --global-diverse --chip-size 256 --target-chips 5000 --output cache/lejepa_dataset_global_256 --push-to-hub ANONYMOUS/sentinel2-lejepa-global-diverse-256`.
