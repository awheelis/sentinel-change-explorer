...
**Author:** Alex + Claude
**Date:** 2026-04-04
**Prerequisite:** `feat/lejepa-experimental` branch (ViT-Tiny/8, 128×128, 1200 steps) already published at `ANONYMOUS/lejepa-vit-tiny-patch8-sentinel2-5band`.
...
- **Republish as a new HF dataset.** `ANONYMOUS/sentinel2-lejepa-preset-biased-small-256` (or similar). The existing 128 dataset stays published for reproducibility of the current ViT-Tiny checkpoint.
