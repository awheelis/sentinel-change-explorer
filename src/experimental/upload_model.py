...
Usage:
    uv run python -m src.experimental.upload_model \\
        ...
        --repo-id falafel-hockey/lejepa-vit-small-patch8-256-sentinel2-5band
...
def _cli() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "'falafel-hockey/lejepa-vit-small-patch8-256-sentinel2-5band')."
        ),
    )
    parser.add_argument(
        "--dataset-repo-id", type=str,
        default="falafel-hockey/sentinel2-lejepa-global-diverse-256",
